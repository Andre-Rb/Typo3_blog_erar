...
/**
 * Test case for class Dawin\BlogErar\Controller\CategoryController.
 *
...
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Dawin\BlogErar\Controller\CategoryController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Dawin\\BlogErar\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	{
		$category = new \Dawin\BlogErar\Domain\Model\Category();
