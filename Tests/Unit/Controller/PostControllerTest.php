...
/**
 * Test case for class Dawin\BlogErar\Controller\PostController.
 *
...
class PostControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Dawin\BlogErar\Controller\PostController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Dawin\\BlogErar\\Controller\\PostController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllPostsFromRepositoryAndAssignsThemToView()
	{
		...
		$postRepository = $this->getMock('Dawin\\BlogErar\\Domain\\Repository\\PostRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$post = new \Dawin\BlogErar\Domain\Model\Post();
